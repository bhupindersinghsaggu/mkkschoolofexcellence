    ...
    <div class="container">
        <div class="d-md-flex justify-content-between align-items-top mb-5 mb-lg-0">
            <div class="sec-intro">
                ...
                <h2 class="sec-title mb-0">Lfghfghatest <span class="color">Activities</span></h2>
            </div>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="event-entry shadow-sm overflow-hidden rounded-4">
                            <div class="event-thumb">
                                <img class="card-img-top" src="admin-panel/gallery/uploads/<?= htmlspecialchars($img['filename']) ?>" alt="Image">
                            </div>
