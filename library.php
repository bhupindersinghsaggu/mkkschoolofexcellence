    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                ...
                <p class="line-heigth pt-4">Our library houses a rich and diverse collection of resources, including storybooks, reference books, encyclopedias, academic journals, biographies, newspapers, magazines, and digital learning materials. From young readers to senior students, every learner finds books that spark interest, imagination, and critical thinking.
                </p>
                <p class="line-heigth">The library is equipped with comfortable seating, proper lighting, and a structured cataloging system for easy access to information. Guided by a supportive librarian, students are encouraged to develop good reading habits, independent study skills, and a deep appreciation for literature.</p>
