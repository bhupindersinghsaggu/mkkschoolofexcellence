...
<section class="single-post sec-padding">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                <p class="line-heigth">School of Excellence, where education meets inspiration. We believe that every child is born with unique talents and unlimited potential, and our mission is to nurture that potential through holistic and value-based education.
                </p>
                <p class="line-heigth">At School of Excellence, learning goes beyond textbooks. Our curriculum is designed to develop academic excellence, creativity, confidence, discipline, leadership, and strong moral values. With experienced faculty, modern teaching methods, and a safe, supportive environment, we ensure that every student grows intellectually, emotionally, socially, and physically. Our school campus provides well-equipped classrooms, advanced labs, smart learning facilities, sports and activity arenas, and opportunities for cultural and personality development. We aim to create responsible global citizens who are ready to face the challenges of the future with courage and capability.</p>
                <h5>Vision</h5>
