    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                ...
                <p class="line-heigth" style="color: #3a4bff"><i class="fa-solid fa-circle-arrow-right"></i> Tuition fee ( PreN to Prep ) - ₹6000/-</p>
               <p class="line-heigth" style="color: #3a4bff"> <i class="fa-solid fa-circle-arrow-right"></i> Classes 1 to 5 - ₹7250/-</p>
               <p class="line-heigth" style="color: #3a4bff"> <i class="fa-solid fa-circle-arrow-right"></i> Class 6 - ₹7500/-</p>
               <p class="line-heigth" style="color: #3a4bff"> <i class="fa-solid fa-circle-arrow-right"></i> Class 7 - ₹7750/-</p>
               <p class="line-heigth" style="color: #3a4bff"><i class="fa-solid fa-circle-arrow-right"></i> A Sibling discount of 20% on the Tuition fee of the elder sibling.</p>
                <h5> Transport charges</h5>
               <p class="line-heigth" style="color: #3a4bff"><i class="fa-solid fa-circle-arrow-right"></i>  1800/- within 1 KM</p>
               <p class="line-heigth" style="color: #3a4bff"> <i class="fa-solid fa-circle-arrow-right"></i> 2200/- afterwards</p>
            </div>
        </div>
    </div>
</section>
