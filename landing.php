      ...
      <div class="container">
         <div class="row">
            <div class="d-flex flex-column flex-md-row justify-content-center align-items-center gap-3 text-center">
               <a href="landing.php">
                  <img src="images/logo-landing.png" class="landind-logo" alt="Logo" class="img-fluid">
               </a>
         ...
         <div class="row ">
            <div class="d-flex justify-content-center gap-5  mobile-row">
               <div class="about-media-2 position-relative mb-4 mb-xl-0">
                  <img class="img-fluid" src="images/hero1.png" alt="About">
               </div>
               <div>
      ...
      <div class="container">
         <div class="row ">
            <div class="col-lg-6 col-md-6 order-md-1 order-2">
               <div class="contact-form position-relative z-index bg-secondary2  p-4 rounded-3" style="border: 2px #eeeeee solid;">
            ...
            <div class="col-lg-6 col-md-6 order-md-2 order-1">
               <div class="contact-txt">
                  <h2 class="sec-title mb-4  ">Talk to <span class="color">Our Admission Counsellor</span></h2>
