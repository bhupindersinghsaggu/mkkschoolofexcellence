            ...
            <div class="row align-items-center">
                <div class="col-xl-6 px-lg-0">
                    <div class="">
                        ...
                        <div class="about-cta mt-5 d-flex mb-5">
                ...
                <div class="col-xl-6">
                    <div class=" position-relative mb-4 mb-xl-0">
                        <img class=" img-fluid " src="images/banner-2.png">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7 col-md-7 order-md-1 order-2">
                    <div class="contact-form position-relative z-index bg-secondary1 p-lg-5 p-4 rounded-3">
                        <form id="contactform" class="row">
                            <div class="col-lg-6 form-group">
                                <i class="feather-icon icon-user"></i>
                                <input class="form-control blue-border" name="name" id="name" type="text" placeholder="Name" required="">
                            </div>
                            <div class="col-lg-6 form-group">
                                <i class="feather-icon icon-mail"></i>
                                <input class="form-control blue-border" name="email" id="email" type="email" placeholder="Email Address" required="">
                            </div>
                            <div class="col-lg-6 form-group">
                                <i class="feather-icon icon-phone-call"></i>
                                <input class="form-control blue-border" type="text" id="phone" name="phone" placeholder="Phone Number" required="">
                            </div>
